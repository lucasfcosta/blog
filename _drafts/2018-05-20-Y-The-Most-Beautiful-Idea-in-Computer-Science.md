...
Now that we know what a combinator is, let's go straight to the meatiest part of this subject and derive the Y-Combinator itself. Trust me, all the other questions you've got in your mind are gonna be answered while we do this.
...
This looks familiar, doesn't it? It's exactly what we want as we have shown above, we want to be able to nest infinite calls to `factorialGenerator` inside of itself whenever we need to do recursion.
