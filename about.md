...
I write JavaScript most of the time, and I’m passionate about open-source. For the past few years, I have been a maintainer of [Chai.js](http://chaijs.com/) and [Sinon.js](http://sinonjs.org/), and have contributed to numerous other projects, including [Jest](https://github.com/facebook/jest) and [Nodeschool](https://nodeschool.io/).

I'm the author of [_Testing JavaScript Applications_](https://www.manning.com/books/testing-javascript-applications), a book published by [Manning Publications](https://www.manning.com/).
