...
If you want to build a car you should not start by assembling the wheels, before adding the chassis, the engine and the interior. Before building a car you need to know how to build a skateboard.
